...
base_model_root = f"model/general_models_new/{time_stamp}/alpha1.0_seq_len{seq_len}_{expert_tag}"
...
print(f"[hatespeech_defer_general] expert curve: {expert_data_path}")
print(f"[hatespeech_defer_general] expert_tag={expert_tag} seeds={seed_list}")
...
for seed in seed_list:
    ...
    csv_path = os.path.join(model_root, "metrics_eval_test.csv")
